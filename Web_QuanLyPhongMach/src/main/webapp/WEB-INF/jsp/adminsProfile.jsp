...
<c:url value="/admins/adminsProfile" var="action" />
<form:form id="updateProfileAdmin" method="post" action="${action}" modelAttribute="updateProfileAdmin" enctype="multipart/form-data">
...
<script src="<c:url value="/js/adminProfile.js" />"></script>
<script>
