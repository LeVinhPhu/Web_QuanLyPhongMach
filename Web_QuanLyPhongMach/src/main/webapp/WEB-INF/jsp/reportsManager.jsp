...
<div class="col-md-2 col-12 btn btn-success">
    <a 
        href="<c:url value="/admins/adminIndex"/>" 
        style="text-decoration: none; color: white">Quay lại
    </a>
</div>
...
<div class="contents">
    ...
    <div class="left">
        <ul class="leftContent">
            <li><a href="#rightContent0">Tổng doanh thu</a></li>
            <li><a href="#rightContent1">Doanh thu theo năm</a></li>
            <li><a href="#rightContent2">Doanh thu theo quý</a></li>
            <li><a href="#rightContent3">Doanh thu theo tháng</a></li> 
        </ul>
    </div>
    ...
    <div class="right">
        ...
        <div class="rightContent">
            <div class="pt-2 pb-1 ct content0">
        ...
        <div class="rightContent">
            <div class="pt-2 pb-1 ct content1">
                <h5 class="text-center">DOANH THU THEO NĂM</h5>
            </div>

            <div class="myBorder1 row">  
        ...
        <div class="rightContent">
            <div class="pt-2 pb-1 ct content2 ">
                <h5 class="text-center">DOANH THU THEO QUÝ</h5>
            </div>
            <div class=" myBorder2 row">
        ...
        <div class="rightContent">
            <div class="pt-2 pb-1 ct content3">
                <h5 class="text-center">DOANH THU THEO THÁNG</h5>
            </div>
            <div class=" myBorder3 row">
