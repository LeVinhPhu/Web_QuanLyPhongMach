        ...
        for (let i = 0; i < data.length; i++)
            if (data[i].id == id)
            {
                ...
                <div>
                    ...
                    <h6>Chức vụ: ${data[i].position}</h6> 
                    <h6>Chuyên ngành: Khoa Ngoại</h6>
                    <h6>Địa chỉ: 78 Trần Phú</h6>
                    <h6>Email: vinhphuvtv2@gmail.com</h6>
                    <h6>Phone: 0865302312</h6>
                    <h6>Username: vinhphuvtv2</h6>
